...
Shader "Shader Forge/Examples/Custom Lighting" {
    Properties {
        ...
        _Gloss ("Gloss", Range(0, 1)) = 0.3827517
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
